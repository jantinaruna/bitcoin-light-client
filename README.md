<p align="center">
  <b>bitcoin-light-client</b>
</p>

<p align="center">
  <sub>spv · electrum-server · plugins</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>BtcLight</code> &nbsp;·&nbsp; <code>btclight</code>
</p>
...
Lightweight Bitcoin client — connect your own node or public electrum servers, watch-only imports.

Repo title matches the query, not a product brand.
...
```bash
dotnet restore bitcoin-light-client.slnx
dotnet build bitcoin-light-client.slnx -c Release
dotnet test bitcoin-light-client.slnx -c Release
```
