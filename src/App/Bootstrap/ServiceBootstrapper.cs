using BtcLight.App.Commands;
using BtcLight.ChainProviders.Evm;
using BtcLight.ChainProviders.Transport;
using BtcLight.ChainProviders.Utxo;
using BtcLight.Cryptography.Derivation;
using BtcLight.Cryptography.Vault;
using BtcLight.Engine.Analytics;
using BtcLight.Engine.Domain.Contracts;
using BtcLight.Engine.Networks;
using BtcLight.Engine.Options;
using BtcLight.Engine.Orchestration;
using BtcLight.Persistence.Stores;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace BtcLight.App.Bootstrap;
